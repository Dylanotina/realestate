  ...
  <Box maxWidth="1000px" margin="auto" p="4">
    ...
    <Box w="full" p="6">
      ...
      <Flex flexWrap="wrap" textTransform="uppercase" justifyContent="space-between">
        ...
        <Flex justifyContent="space-between" w="400px" borderBottom="1px" borderColor="gray.100" p="3">
            <Text>Purpose</Text>
            <Text fontWeight="bold">{purpose.replace(/-/g, " ")}</Text> 
        </Flex>
      ...
      <Flex flexWrap="wrap">
        {amenities.map(item => (
            item.amenities.map(amenity => (
                <Text fontWeight="bold" color="blue.400" bg="gray.200" borderRadius="5" fontSize="l" padding="2" m="1" key={amenity.text}>{amenity.text}</Text>
            ))
        ))}
      </Flex>
      </Box>
